...
export default function Face() {
    ...
    face.addEventListener('mouseenter',()=>{expr(yesEx);ReyeOp = false});
    face.addEventListener('mouseleave',()=>{expr(normEx);ReyeOp = true});
    
    face.addEventListener('focus',()=>{expr(yesEx);ReyeOp = false});
    face.addEventListener('blur',()=>{expr(normEx);ReyeOp = true});
    let check = true
    window.addEventListener('mousemove',(event)=>{
        if(check == true && ReyeOp == true){
            ...
            Leye.attributes.d.value=leftEyeMove(moveLeftEye)
            Reye.attributes.d.value=rightEyeMove(moveRightEye)
    ...
    <svg id="face" style={{height:200,margin:"0 30px 20px"}} role="img" aria-label="Save" viewBox="0 0 149 203" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g fill={colors.drGreen}>
            <path id="LeyeSh" d="M40.4 93.1L61.2 99.6L65.7 105.1L73.2 113.2L73.9 105.6L71.9 99.1L63.7 96.3L40.4 93.1Z"/>
            ...
            <path id="nose" d="M86.1 100.3L92.9 97.4L117.3 93.6L94.1 100.3L88.9 107.6L89.5 122.2L96 129L93.4 138.8L81.3 140.4L75.4 140.3L62.4 137.8L59.9 128.6L63.3 134.4L72.6 132.2L80.1 134.6L86.8 132.2L88.9 126.7L84.8 119.4L84.6 106.6L86.1 100.3Z"/>
            <path id="TLip" d="M54.6 154.4L57.1 153.4L73.7 151.2L76.4 152.5L80.1 151.8L95.7 155.5L98.4 157.2L97.6 158.2L82.7 155.7L76.4 156.4L70.5 155.2L56.6 156.3L54.6 154.4Z"/>
            <path id="BLip" d="M64.9 165.5L71.9 171.6L81.5 172.5L87.6 165.9L82.6 167.6L70.2 166.8L64.9 165.5Z"/>
        </g>
        <g fill={colors.black}>
            ...
            <path id="Rnosed" d="M83.3 137.7L87.1 135.7L91.8 136.5L87.5 138.2L83.3 137.7Z"/>
            <path id="Reye" d="M104.6 97.5L112.5 98.3L118.6 102.4L111.9 100.6L108.8 100.4L108 103.5L104.4 105L100.6 103.4L100 100.4L95.4 101.3L92.8 102.9L94.5 100.3Z"/>
            <path id="Leye" d="M54.1 97.3L61.7 99.7L63.9 102.4L61.1 100.6L58.4 100.3L57.9 102.9L53.8 104.4L49.4 102.8L48.9 99.9L45.6 99.8L40.8 101.6L45.2 98.6Z"/>
            <path id="mustch" d="M50.2 154.8L51.7 149.4L71.2 143.5L77.4 145.3L83.1 145L102.6 151.5L103.1 156.9L100.2 154.5L82.7 148.3L76.6 148.7L71.9 147.3L53.1 152.8L50.2 154.8Z"/>
            <path id="ReyeB" d="M86.1 100.3L90.2 92.7L119.2 86.6L126.1 99.4L117.3 93.6L92.9 97.4L86.1 100.3Z"/>
            <path id="LeyeB" d="M30.3 97.9L39.4 85.7L65.2 91.2L71.9 99.1L63.7 96.3L40.4 93.1L30.3 97.9Z"/>
        </g>
