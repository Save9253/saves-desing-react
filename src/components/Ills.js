...
export function Logo(props){
    return(
        <svg height={props.height} viewBox="0 0 165 202" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M97 2L2 129L11 146L62 200L163 139L145 62L136 45L74 120L106 18L97 2Z" fill={mdGreen} stroke={black} stroke-width="1"/>
            <path d="M41 16L2 129L50 180L151 118L136 45L64 103L97 2L41 16Z" fill={black}/>
            <path d="M97 2L41 16L2 129L11 146L62 200L163 139L145 62L136 45L84 87L106 18L97 2Z" stroke={black} stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
export function Cart(props){
    return(
        <svg height={props.height} viewBox="0 0 184 171" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M115 104L125 135" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke={black}/>
            <g fill={ltGreen}>
            ...
            <g stroke-width="3" stroke-linecap="round" stroke-linejoin="round" stroke={black}>
...
export function Home(props){
    return(
        <svg height={props.height} viewBox="0 0 204 154" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g fill={ltGreen} stroke={black} stroke-width="3" stroke-linejoin="round">
...
export function Blog(props){
    return(
        <svg height={props.height} viewBox="0 0 163 179" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g fill={ltGreen}>
            ...
            <path d="M107 2L17 17L6 22L2 37L6 52L17 57L32 55V157L36 172L47 177L137 162L148 157L152 142L148 127L137 122L122 125V82L128 79L122 76V75L130 76L145 62L140 58L149 59L161 37L161 17L142 21L131 27L125 40L125 29L122 32V22L118 7L107 2Z" stroke={black} stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
export function Icon(props){
    return(
        <svg height={props.height} viewBox="0 0 194 194" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M94 2L29 29L2 94L29 159L35 165L100 192L165 165L192 100L165 35L159 29L94 2Z" stroke={black} stroke-width="3" stroke-linejoin="round"/>
        </svg>
    )
}
export function Domain(props){
    return(
        <svg height={props.height} viewBox="0 0 224 113" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M2 2V101L12 111H222V12L212 2H2Z" stroke={black} stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
export function Ills(props){
    return(
        <svg height={props.height} viewBox="0 0 199 149" fill="none" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
            <path d="M197 2H2V147H197V2Z" fill={ltGreen} stroke={black} stroke-width="3"/>
...
export function Sec(props){
    return(
        <svg height={props.height} viewBox="0 0 205 104" fill={mdGreen} xmlns="http://www.w3.org/2000/svg">
            <path d="M202.9 15.5H2.4V88.2H202.9V15.5Z" fill={ltGreen} stroke={black} stroke-width="3" stroke-linejoin="round"/>
...
export function Style(props){
    return(
        <svg height={props.height} viewBox="0 0 225 136" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M100 7L75 16L63 32L67 51L64 52L8 38L3 39L6 43L54 59L53 60L29 64L17 87L35 119L39 123L84 134L157 129L215 96L223 59L202 28L199 24L155 8L100 7ZM123 28L128 33L123 43L103 50L87 50L83 45L89 34L105 28L123 28Z" stroke={black} stroke-width="3"/>
        </svg>
    )
}
export function Form(props){
    return(
        <svg height={props.height} viewBox="0 0 212 186" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M209.3 2.5H2.2V183.5H209.3V2.5Z" fill={ltGreen} stroke={black} stroke-width="3.6" stroke-linejoin="round"/>
            <g fill={mdGreen}>
...
export function Hosting(props){
    return(
        <svg height={props.height} viewBox="0 0 249 141" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M120 2L92 8L69 24L55 49L48 48L27 52L10 68L2 94L9 118L26 134L48 139H192L221 132L240 111L247 84L241 58L220 36L192 30L176 32L161 16L142 6L120 2Z" fill={ltGreen} stroke={black} stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
...
export function Auth(props){
    return(
        <svg height={props.height} viewBox="0 0 123 202" fill="none" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M61 2L29 15L16 47V84C23 84 21 84 33 84V48L41 28L61 19L83 28L91 49V73L95 76L103 76L107 73V49L95 17L92 15L61 2Z" stroke={black} stroke-width="3"/>
            ...
            <path d="M2 82V194L8 200H121V88L115 82H2Z" stroke={black} stroke-width="3" />
        </svg>
    )
}