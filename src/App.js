  ...
  return (
    <React.Fragment>
      ...
      <div style={styles.linkDiv}>
        <p style={{margin:'0 2px'}}><b>Check Save's projects on</b></p>
        <a style={styles.link} className="icon" href='https://www.behance.net/saveliy_saunin'>
      ...
      <div style={styles.linkDiv}>
        <p style={{margin:'0 2px'}}><b>Connect with Save on</b></p>
        <a style={styles.link} className="icon" href='https://www.linkedin.com/in/saveliy-saunin/'>
      ...
      <div style={styles.linkDiv}>
        <p style={{margin:'0 2px'}}><b>Email Save</b></p>
        <a style={styles.link} href="mailto:contact.saves.design@gmail.com">contact.saves.design@gmail.com</a>
      </div>
    </React.Fragment>
  );
}
